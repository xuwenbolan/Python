...
url = "https://49-89-185-96.d.cjjd20.com:30443/123-493/ca3884d7/1813944254-0/ca3884d7af72b861dd18df752539e1ed?v=2&t=1676011664&s=4fe3717f6a2393e2255584cce8a25e08&filename=[Sakurato]+Mushoku+Tensei+Isekai+Ittara+Honki+Dasu+[15][AVC-8bit+1080p%4060FPS+AAC][CHS].zip&d=9f55e82e"
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=10) as t:
        for s_pos,e_pos in parts:
            t.submit(range_download,filename,s_pos,e_pos).add_done_callback(get_speed)
    end = time.time()
    print(end - start)
...
def get_speed(self):
    ...
    downsize += MB
    speed = downsize/(time.time()-start)
